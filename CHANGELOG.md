...
- `score` / `baseline` print machine-parseable tokens: `STATUS=…`, plus on score `EXPERIMENT=`, `PARENT=`, `DECISION=`, `BEST=` (exit 0 keep/discard, 1 crash, 2 budget with `STATUS=budget_exceeded`).
